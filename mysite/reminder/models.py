...
#     django_user = models.OneToOneField(DjangoUser, null=True, on_delete=models.CASCADE)
#
...
class Task(models.Model):
    ...
    user = models.ForeignKey(Profile, to_field="name", null=True, on_delete=models.CASCADE)
